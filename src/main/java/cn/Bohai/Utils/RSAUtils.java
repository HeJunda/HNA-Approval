...
public class RSAUtils {
	...
	public static String decryptByPrivateKey(String content,
		...
		byte[] decryptedData = decryptByPrivateKey(Base64.decodeBase64(content), privateKey);
	...
	public static String decryptByPublicKey(String content,
			String publicKey, String inputCharset) throws Exception {
		byte[] decryptedData = decryptByPublicKey(Base64.decodeBase64(content), publicKey);
        return new String(decryptedData, inputCharset);
	}
	...
	public static String encryptByPublicKey(String content, String publicKey, String inputCharset)
        ...
        byte[] dataEncryptData = encryptByPublicKey(data, publicKey);
        return Base64.encodeBase64String(dataEncryptData);
	}
	...
	public static String encryptByPrivateKey(String content, String privateKey, String inputCharset)
			throws Exception {
		byte[] data = content.getBytes(inputCharset);
        byte[] dataEncryptData = encryptByPrivateKey(data, privateKey);
        return Base64.encodeBase64String(dataEncryptData);
	}
    ...
    public static String loadKeyString(String keyFile){
        ...
        try {
            in=RSAUtils.class.getResourceAsStream("/"+keyFile);
    ...
    public static String loadKeyStringByPath(String keyFile){
        ...
        try {
        	...
        	logger.error("loadKeyStringByPath error, message: " + e.getMessage());
