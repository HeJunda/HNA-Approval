		                    ...
		                    result +=   '<li class="clearfix">'
							      		+'<a href="/followAwait.html?taskid='+data[i].taskid+'">'
							      			+'<div class="agency-right">'
							            		+'<div class="right-box">'
							           				+'<p class="follow-person">发送人：<span class="fr">'+data[i].sendername+'</span></p>'
							           				+'<p class="follow-person">创建时间：<span class="fr">'+data[i].createtime+'</span></p>'
							           				+'<p class="follow-person">流程发起部门：<span class="fr">'+data[i].startorg+'</span></p>'
							           				+'<p class="follow-person">流程发起人：<span class="fr">'+data[i].startname+'</span></p>'
							           			+'</div>'
							           		+'</div>'
							           	+'</a>'	
							      	+'</li>'
					                	...
					                	+'<a href="/followAlready.html?instanceid='+data[i].instanceid+'">'
							      			+'<div class="agency-right">'
							            		+'<div class="right-box">'
							           				...
							           				+'<p class="follow-person">流程发起部门：<span class="fr">'+data[i].startorg+'</span></p>'
							           				+'<p class="follow-person">流程发起人：<span class="fr">'+data[i].startname+'</span></p>'
							           				+'<p class="follow-person">知会处理人：<span class="fr">'+data[i].recivertime+'</span></p>'
							           				+'<p class="follow-person">知会意见：<span class="fr">'+data[i].noticemsg+'</span></p>'
							           			+'</div>'
							           		+'</div>'
							           	+'</a>'
									+'</li>'
