				                    ...
				                    result += '<li class="clearfix">'
									      		+'<a href="'+hrefs+'">'
									      			+'<div class="agency-right">'
									            		+'<div class="right-box">'
									            			+'<p class="follow-person">流程名称：<span class="fr follr" style="width: 16%;overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">'+(data[i].taskname==undefined?"":data[i].taskname)+'</span></p>'
				                ...
				                for(var i = 0; i < data.length; i++){
				                    result +=   '<li class="clearfix">'
									      		+'<a href="/followAwait.html?taskid='+data[i].taskid+'">'
									      			+'<div class="agency-right">'
									            		+'<div class="right-box">'
									            			+'<p class="follow-person">流程名称：<span class="fr follr" style="width: 16%;overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">'+data[i].taskname+'</span></p>'
